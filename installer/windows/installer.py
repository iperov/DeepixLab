...
''')
        subprocess.Popen(args=f'bin\code.cmd --disable-workspace-trust --install-extension ms-python.python', cwd=self._vscode_path, shell=True, env=self._env).wait()
        subprocess.Popen(args=f'bin\code.cmd --disable-workspace-trust --install-extension ms-python.vscode-pylance', cwd=self._vscode_path, shell=True, env=self._env).wait()
        subprocess.Popen(args=f'bin\code.cmd --disable-workspace-trust --install-extension ms-python.isort', cwd=self._vscode_path, shell=True, env=self._env).wait()
        subprocess.Popen(args=f'bin\code.cmd --disable-workspace-trust --install-extension searking.preview-vscode', cwd=self._vscode_path, shell=True, env=self._env).wait()
